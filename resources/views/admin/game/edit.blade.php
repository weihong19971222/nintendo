...
@section('content')
<form method="POST" action="/admin/game/{{$gamesoftwas->id}}" enctype="multipart/form-data">
    @csrf
    @method("PUT")
    <div class="form-group">
        <label for="game_name">遊戲名稱</label>
        <input name="game_name" value="{{$gamesoftwas->game_name}}" type="text" class="form-control" id="game_name" required>
    </div>
    <div class="form-group">
        <label for="">遊戲圖片</label><br>
